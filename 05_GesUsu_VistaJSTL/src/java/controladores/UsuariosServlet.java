    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ServicioUsuarios.getInstancia().validarLoginUsuario(email, password) 
            ...
            switch(request.getMethod()){
                ...
                case "GET":
                    request.getSession().setAttribute("todosUsuarios", ServicioUsuarios.getInstancia().obtenerTodos());
                ...
                case "POST":
                    ...
                    switch(metodo){
                        case "PUT":
                            ServicioUsuarios.getInstancia().modificar(id, nom, strId, email, password);
                            request.getSession().setAttribute("todosUsuarios", ServicioUsuarios.getInstancia().obtenerTodos());
                            request.getRequestDispatcher("listar.jsp").forward(request, response);
                            break;
                        case "DELETE":
                ...
                case "POST":
                    ...
                    switch(resultado){
                        ...
                        case CamposMal:
                            ...
                            break;
                        case ErrorDB:
                            request.getSession().setAttribute("mensaje error", "Error en db");
                            request.getRequestDispatcher("registrarse.jsp").forward(request, response);
                            break;
                    }
                    break;
                default:
                    request.getSession().setAttribute("mensaje Error", "login invalido");
